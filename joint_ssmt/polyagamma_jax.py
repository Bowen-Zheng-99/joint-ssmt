...
# ==============================================================================
# Constants
# Use plain Python math for module-level constants so that importing this
# module never triggers JAX compilation.  This avoids XlaRuntimeError on
# backends that do not support float64 (e.g. Apple-Silicon Metal).
# The values are wrapped as jnp scalars lazily inside JIT-compiled functions.
# ==============================================================================

PI = math.pi
PI_2 = PI / 2.0
PI2_8 = PI * PI / 8.0
LOGPI_2 = math.log(PI / 2.0)
