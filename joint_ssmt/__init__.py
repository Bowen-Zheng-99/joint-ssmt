...
# Highest-level "data in, figures out" wrapper (user-facing)
from joint_ssmt.auto import run_auto_inference

# Bundled demo dataset and a short test
from joint_ssmt.demo import load_demo_data, test
...
__all__ = [
    ...
    "load_results_trials",
    "run_auto_inference",
    # Bundled data and test (user-facing)
    "load_demo_data",
    "test",
    # Summary plotting (user-facing)
    "plot_coupling_summary",
